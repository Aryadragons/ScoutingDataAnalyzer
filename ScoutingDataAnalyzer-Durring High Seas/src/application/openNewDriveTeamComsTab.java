...
public class openNewDriveTeamComsTab extends GridPane implements EventHandler<ActionEvent>{
	...
	public void addDTCEnterySetUp() {
		...
		Label enterDisTL = new Label("Discrimination Type:");
		...
		enterDisTL.setId("TitleLabelPlay");
		...
		enterTeamNumVB.getChildren().addAll(enterTeamNumL, enterTeamNum);
		VBox enterMatchVB = new VBox(5);
		enterMatchVB.getChildren().addAll(enterMatchL, enterMatch);
		VBox enterYellVB = new VBox(5);
		enterYellVB.getChildren().addAll(enterYellL, enterYell);
		VBox enterConVB = new VBox(5);
		enterConVB.getChildren().addAll(enterConL, enterControl);
		VBox enterPhyVB = new VBox(5);
		enterPhyVB.getChildren().addAll(enterPhyL, enterPhysical);
		VBox enterDisLVB = new VBox(5);
		enterDisLVB.getChildren().addAll(enterDisLL, enterDiscrim);
		VBox enterDisTVB = new VBox(5);
		enterDisTVB.getChildren().addAll(enterDisTL, enterDisCrimType);
		VBox enterOtherBVB = new VBox(5);
		enterOtherBVB.getChildren().addAll(enterOtherBL, enterOtherB);
		VBox enterFunVB = new VBox(5);
		enterFunVB.getChildren().addAll(enterFunL, enterFun);
		VBox enterStratVB = new VBox(5);
		enterStratVB.getChildren().addAll(enterStratL, enterStrategy);
		VBox enterOtherGVB = new VBox(5);
		enterOtherGVB.getChildren().addAll(enterOtherGL, enterOtherG);
		...
		enterConBP.setId("openDTCBP5");
		enterPhyBP.setId("openDTCBP6");
		enterDisLBP.setId("openDTCBP7");
		enterDisTBP.setId("openDTCBP8");
		enterOtherBBP.setId("openDTCBP9");
		enterFunBP.setId("openDTCBP8");
		enterStratBP.setId("openDTCBP7");
		enterOtherGBP.setId("openDTCBP6");
		this.add(new Label("    "), 0, 4);
		this.add(new Label("    "), 0, 6);
		HBox row1HB = new HBox(5);
		row1HB.getChildren().addAll(enterTeamNumBP, enterMatchBP, enterYellBP, enterConBP, enterPhyBP, enterDisLBP);
		HBox row2HB = new HBox(5);
		row2HB.getChildren().addAll(enterDisTBP, enterOtherBBP, enterFunBP, enterStratBP, enterOtherGBP, enterComsBP);
		this.add(row1HB, 1, 5);
		this.add(row2HB, 1, 7);
		addEnterB = new Button("Enter");
		addEnterB.setOnAction(this);
		this.add(addEnterB, 1, 8);
	}
