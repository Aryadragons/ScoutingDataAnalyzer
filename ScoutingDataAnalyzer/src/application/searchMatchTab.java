...
public class searchMatchTab extends GridPane implements EventHandler<ActionEvent>{
	...
	public void setPlayoffStuff(int selAll, int matchNum, boolean isRePlay) {
		...
		Team nonTeam3 = null;
		Team nonTeam4 = null;
		System.out.println("boopseMPlay4");
		if(selAll == 1) {
		...
		System.out.println("boopseMPlay5");
		...
		blueSortedTeams.add(null);
		blueSortedTeams.add(null);
		blueSortedTeams.add(null);
		blueSortedTeams.add(null);
		System.out.println("BoopMplay5. " + blueSortedTeams.size());
		redSortedTeams.add(null);
		redSortedTeams.add(null);
		redSortedTeams.add(null);
		redSortedTeams.add(null);
		...
		System.out.println("boopseMPlay6");
		for(int i = 0; i < allsMatch.size(); i++) {
			System.out.println("boopseMPlay6.1");
			Match m = allsMatch.get(i);
			boolean mColor = m.getAllianceColor();
			System.out.println("boopseMPlay6.2 " + m.getMatchTeamNum() + " 1: " + mainTeamNum1 + " 2: " + mainTeamNum2 + " 3: " + mainTeamNum3 + " 4: " + mainTeamNum4);
			if(m.getMatchTeamNum() == mainTeamNum1) {
				System.out.println("boopseMPlay6.3");
				mainColor = mColor;
				if(mainColor == false) {
					blueTeams.add(m);
				...
				System.out.println("boopseMPlay6.4");
				mainColor = mColor;
				if(mainColor == false) {
					blueTeams.add(m);
				...
				System.out.println("boopseMPlay6.5");
				mainColor = mColor;
				if(mainColor == false) {
					blueTeams.add(m);
				...
				System.out.println("boopseMPlay6.6");
				mainColor = mColor;
				if(mainColor == false) {
					blueTeams.add(m);
		...
		System.out.println("boopseMPlay7" + mainColor);
		int nonAllNum;
		HBox blueHB = new HBox(6);
		HBox redHB = new HBox(6);
		System.out.println("boopseMPlay7.0");
		if(mainColor == false) {
			System.out.println("boopseMPlay7.1");
			...
			System.out.println("boopseMPlay7.2");
			if(nonAllNum == 2) {
				for(int i = 0; i < redTeams.size(); i++) {
			...
			System.out.println("boopseMPlay7.3");
			if(nonAllNum == 3) {
				for(int i = 0; i < redTeams.size(); i++) {
			...
			System.out.println("boopseMPlay7.4");
			if(nonAllNum == 4) {
				for(int i = 0; i < redTeams.size(); i++) {
			...
			System.out.println("boopseMPlay7.5");
			if(nonAllNum == 5) {
				for(int i = 0; i < redTeams.size(); i++) {
			...
			System.out.println("boopseMPlay7.6");
			if(nonAllNum == 6) {
				for(int i = 0; i < redTeams.size(); i++) {
			...
			System.out.println("boopseMPlay7.7");
			if(nonAllNum == 7) {
				for(int i = 0; i < redTeams.size(); i++) {
			...
			System.out.println("boopseMPlay7.8");
			if(nonAllNum == 8) {
				for(int i = 0; i < redTeams.size(); i++) {
			...
			System.out.println("boopseMPlay7.9");
				...
				for(int i = 0; i < blueTeams.size(); i++) {
					...
					if(thePOA.getAlliance1().getTeam1() != null) {
						if(blueTeams.get(i).getMatchTeamNum() == thePOA.getAlliance1().getTeam1().getTeamNum()) {
							...
							isBlueTeam1 = true;
							 ...
							 blueSortedTeams.add(0, blueTeams.get(i));
							 nonTeam1 = theTL.getATeam(nonTeamNum1);
						}
					}
					if(thePOA.getAlliance1().getTeam2() != null) {
						if(blueTeams.get(i).getMatchTeamNum() == thePOA.getAlliance1().getTeam2().getTeamNum()) {
							...
							blueSortedTeams.add(1, blueTeams.get(i));
							nonTeam2 = theTL.getATeam(nonTeamNum2);
						}
					}
					if(thePOA.getAlliance1().getTeam3() != null) {
						if(blueTeams.get(i).getMatchTeamNum() == thePOA.getAlliance1().getTeam3().getTeamNum()) {
							...
							blueSortedTeams.add(2, blueTeams.get(i));
							nonTeam3 = theTL.getATeam(nonTeamNum3);
						}
					}
					if(thePOA.getAlliance1().getTeam4() != null) {
						if(redTeams.get(i).getMatchTeamNum() == thePOA.getAlliance1().getTeam4().getTeamNum()) {
							...
							blueSortedTeams.add(3, blueTeams.get(i));
							nonTeam4 = theTL.getATeam(nonTeamNum4);
						}
					}
				}
			...
			if(nonAllNum == 2) {
				...
				for(int i = 0; i < blueTeams.size(); i++) {
					...
					if(thePOA.getAlliance2().getTeam3() != null) {
						System.out.println("boopseMPlay7.10.3.1");
						if(blueTeams.get(i).getMatchTeamNum() == thePOA.getAlliance2().getTeam3().getTeamNum()) {
							System.out.println("boopseMPlay7.10.3.2");
							isBlueTeam3 = true;
							System.out.println("boopseMPlay7.10.3.3");
							nonTeamNum3 = blueTeams.get(i).getMatchTeamNum();
							System.out.println("boopseMPlay7.10.3.4");
							blueSortedTeams.add(2, blueTeams.get(i));
							System.out.println("boopseMPlay7.10.3.5");
							nonTeam3 = theTL.getATeam(nonTeamNum3);
							System.out.println("boopseMPlay7.10.3.6");
						}
					}
		...
		System.out.println("boopseMPlay8");
		...
		System.out.println("boopseMPlay9" + mainColor);
		if(mainColor == true) {
			...
			if(nonTeamNum1 != 0) {
				...
				Label blueTeam1NumL = new Label(Integer.toString(nonTeamNum1) + "'s Stats");
				...
				blueTeam1NumL.setId("TitleLabelPlay");
				...
				blue1MatchCyStatL.setId("avgStat");
				blue1MatchSpeStatL.setId("avgStat");
				blue1MatchAmpStatL.setId("avgStat");
				blue1MatchTrapStatL.setId("avgStat");
				blue1MatchCliStatL.setId("savgStat");
				...
				blue1AvgCyStatL.setId("avgStat");
				blue1AvgSpeStatL.setId("avgStat");
				blue1AvgAmpStatL.setId("avgStat");
				blue1AvgTrapStatL.setId("avgStat");
				blue1AvgCliStatL.setId("avgStat");
				...
				blue1AvgCyBP.setTop(blue1AvgCyTitleL);
				blue1AvgSpeBP.setTop(blue1AvgSpeTitleL);
				blue1AvgAmpBP.setTop(blue1AvgAmpTitleL);
				blue1AvgTrapBP.setTop(blue1AvgTrapTitleL);
				blue1AvgCliBP.setTop(blue1AvgCliTitleL);
				blue1AvgCyBP.setCenter(blue1AvgCyStatL);
				blue1AvgSpeBP.setCenter(blue1AvgSpeStatL);
				blue1AvgAmpBP.setCenter(blue1AvgAmpStatL);
				blue1AvgTrapBP.setCenter(blue1AvgTrapStatL);
				blue1AvgCliBP.setCenter(blue1AvgCliStatL);
			...
			if(nonTeamNum2 != 0) {
				...
				Label blueTeam2NumL = new Label(Integer.toString(nonTeamNum2) + "'s Stats");
				...
				Label blue2MatchCyStatL = new Label(Integer.toString(blueSortedTeams.get(1).getMatchSpe() + blueSortedTeams.get(1).getMatchAmp() + blueSortedTeams.get(1).getMatchTrap()));
				...
				blueTeam2NumL.setId("TitleLabelPlay");
				...
				blue2MatchCyStatL.setId("avgStat");
				blue2MatchSpeStatL.setId("avgStat");
				blue2MatchAmpStatL.setId("avgStat");
				blue2MatchTrapStatL.setId("avgStat");
				blue2MatchCliStatL.setId("avgStat");
				...
				blue2AvgCyStatL.setId("avgStat");
				blue2AvgSpeStatL.setId("avgStat");
				blue2AvgAmpStatL.setId("avgStat");
				blue2AvgTrapStatL.setId("avgStat");
				blue2AvgCliStatL.setId("avgStat");
				...
				blue2AvgCyBP.setTop(blue2AvgCyTitleL);
				blue2AvgSpeBP.setTop(blue2AvgSpeTitleL);
				blue2AvgAmpBP.setTop(blue2AvgAmpTitleL);
				blue2AvgTrapBP.setTop(blue2AvgTrapTitleL);
				blue2AvgCliBP.setTop(blue2AvgCliTitleL);
				blue2AvgCyBP.setCenter(blue2AvgCyStatL);
				blue2AvgSpeBP.setCenter(blue2AvgSpeStatL);
				blue2AvgAmpBP.setCenter(blue2AvgAmpStatL);
				blue2AvgTrapBP.setCenter(blue2AvgTrapStatL);
				blue2AvgCliBP.setCenter(blue2AvgCliStatL);
			...
			if(nonTeamNum3 != 0) {
				...
				Label blueTeam3NumL = new Label(Integer.toString(nonTeamNum3) + "'s Stats");
				...
				Label blue3MatchCyStatL = new Label(Integer.toString(blueSortedTeams.get(2).getMatchSpe() + blueSortedTeams.get(2).getMatchAmp() + blueSortedTeams.get(2).getMatchTrap()));
				...
				blueTeam3NumL.setId("TitleLabelPlay");
				...
				blue3MatchCyStatL.setId("avgStat");
				blue3MatchSpeStatL.setId("avgStat");
				blue3MatchAmpStatL.setId("avgStat");
				blue3MatchTrapStatL.setId("avgStat");
				blue3MatchCliStatL.setId("avgStat");
				...
				blue3AvgCyStatL.setId("avgStat");
				blue3AvgSpeStatL.setId("avgStat");
				blue3AvgAmpStatL.setId("avgStat");
				blue3AvgTrapStatL.setId("avgStat");
				blue3AvgCliStatL.setId("avgStat");
				...
				blue3AvgCyBP.setTop(blue3AvgCyTitleL);
				blue3AvgSpeBP.setTop(blue3AvgSpeTitleL);
				blue3AvgAmpBP.setTop(blue3AvgAmpTitleL);
				blue3AvgTrapBP.setTop(blue3AvgTrapTitleL);
				blue3AvgCliBP.setTop(blue3AvgCliTitleL);
				blue3AvgCyBP.setCenter(blue3AvgCyStatL);
				blue3AvgSpeBP.setCenter(blue3AvgSpeStatL);
				blue3AvgAmpBP.setCenter(blue3AvgAmpStatL);
				blue3AvgTrapBP.setCenter(blue3AvgTrapStatL);
				blue3AvgCliBP.setCenter(blue3AvgCliStatL);
			...
			if(nonTeamNum4 != 0) {
				...
				Label blueTeam4NumL = new Label(Integer.toString(nonTeamNum4) + "'s Stats");
				...
				Label blue4MatchCyStatL = new Label(Integer.toString(blueSortedTeams.get(3).getMatchSpe() + blueSortedTeams.get(3).getMatchAmp() + blueSortedTeams.get(3).getMatchTrap()));
				...
				blueTeam4NumL.setId("TitleLabelPlay");
				...
				blue4MatchCyStatL.setId("avgStat");
				blue4MatchSpeStatL.setId("avgStat");
				blue4MatchAmpStatL.setId("avgStat");
				blue4MatchTrapStatL.setId("avgStat");
				blue4MatchCliStatL.setId("avgStat");
				...
				blue4AvgCyStatL.setId("avgStat");
				blue4AvgSpeStatL.setId("avgStat");
				blue4AvgAmpStatL.setId("avgStat");
				blue4AvgTrapStatL.setId("avgStat");
				blue4AvgCliStatL.setId("avgStat");
				...
				blue4AvgCyBP.setTop(blue4AvgCyTitleL);
				blue4AvgSpeBP.setTop(blue4AvgSpeTitleL);
				blue4AvgAmpBP.setTop(blue4AvgAmpTitleL);
				blue4AvgTrapBP.setTop(blue4AvgTrapTitleL);
				blue4AvgCliBP.setTop(blue4AvgCliTitleL);
				blue4AvgCyBP.setCenter(blue4AvgCyStatL);
				blue4AvgSpeBP.setCenter(blue4AvgSpeStatL);
				blue4AvgAmpBP.setCenter(blue4AvgAmpStatL);
				blue4AvgTrapBP.setCenter(blue4AvgTrapStatL);
				blue4AvgCliBP.setCenter(blue4AvgCliStatL);
			...
			if(mainTeamNum1 != 0) {
				...
				Label redTeam1NumL = new Label(Integer.toString(mainTeamNum1) + "'s Stats");
				...
				Label red1MatchCyStatL = new Label(Integer.toString(redSortedTeams.get(0).getMatchSpe() + redSortedTeams.get(0).getMatchAmp() + redSortedTeams.get(0).getMatchTrap()));
				Label red1MatchSpeStatL = new Label(Integer.toString(redSortedTeams.get(0).getMatchSpe()));
				Label red1MatchAmpStatL = new Label(Integer.toString(redSortedTeams.get(0).getMatchAmp()));
				Label red1MatchTrapStatL = new Label(Integer.toString(redSortedTeams.get(0).getMatchTrap()));
				Label red1MatchCliStatL = new Label(Integer.toString(redSortedTeams.get(0).getMatchClimb()));
				...
				Label red1AvgCyStatL = new Label(Double.toString(mainTeam1.getAvgSpe() + mainTeam1.getAvgAmp() + mainTeam1.getAvgTrap()));
				Label red1AvgSpeStatL = new Label(Double.toString(mainTeam1.getAvgSpe()));
				Label red1AvgAmpStatL = new Label(Double.toString(mainTeam1.getAvgAmp()));
				Label red1AvgTrapStatL = new Label(Double.toString(mainTeam1.getAvgTrap()));
				Label red1AvgCliStatL = new Label(Double.toString(mainTeam1.getAvgClimb()));
				redTeam1NumL.setId("TitleLabelPlay");
				...
				red1MatchCyStatL.setId("avgStat");
				red1MatchSpeStatL.setId("avgStat");
				red1MatchAmpStatL.setId("avgStat");
				red1MatchTrapStatL.setId("avgStat");
				red1MatchCliStatL.setId("avgStat");
				...
				red1AvgCyStatL.setId("avgStat");
				red1AvgSpeStatL.setId("avgStat");
				red1AvgAmpStatL.setId("avgStat");
				red1AvgTrapStatL.setId("avgStat");
				red1AvgCliStatL.setId("avgStat");
				...
				red1AvgCyBP.setTop(red1AvgCyTitleL);
				red1AvgSpeBP.setTop(red1AvgSpeTitleL);
				red1AvgAmpBP.setTop(red1AvgAmpTitleL);
				red1AvgTrapBP.setTop(red1AvgTrapTitleL);
				red1AvgCliBP.setTop(red1AvgCliTitleL);
				red1AvgCyBP.setCenter(red1AvgCyStatL);
				red1AvgSpeBP.setCenter(red1AvgSpeStatL);
				red1AvgAmpBP.setCenter(red1AvgAmpStatL);
				red1AvgTrapBP.setCenter(red1AvgTrapStatL);
				red1AvgCliBP.setCenter(red1AvgCliStatL);
			...
			if(mainTeamNum2 != 0) {
				...
				Label redTeam2NumL = new Label(Integer.toString(mainTeamNum2) + "'s Stats");
				...
				Label red2MatchCyStatL = new Label(Integer.toString(redSortedTeams.get(1).getMatchSpe() + redSortedTeams.get(1).getMatchAmp() + redSortedTeams.get(1).getMatchTrap()));
				...
				Label red2AvgCyStatL = new Label(Double.toString(mainTeam2.getAvgSpe() + mainTeam1.getAvgAmp() + mainTeam1.getAvgTrap()));
				Label red2AvgSpeStatL = new Label(Double.toString(mainTeam2.getAvgSpe()));
				Label red2AvgAmpStatL = new Label(Double.toString(mainTeam2.getAvgAmp()));
				Label red2AvgTrapStatL = new Label(Double.toString(mainTeam2.getAvgTrap()));
				Label red2AvgCliStatL = new Label(Double.toString(mainTeam2.getAvgClimb()));
				redTeam2NumL.setId("TitleLabelPlay");
				...
				red2MatchCyStatL.setId("avgStat");
				red2MatchSpeStatL.setId("avgStat");
				red2MatchAmpStatL.setId("avgStat");
				red2MatchTrapStatL.setId("avgStat");
				red2MatchCliStatL.setId("avgStat");
				...
				red2AvgCyStatL.setId("avgStat");
				red2AvgSpeStatL.setId("avgStat");
				red2AvgAmpStatL.setId("avgStat");
				red2AvgTrapStatL.setId("avgStat");
				red2AvgCliStatL.setId("avgStat");
				...
				red2AvgCyBP.setTop(red2AvgCyTitleL);
				red2AvgSpeBP.setTop(red2AvgSpeTitleL);
				red2AvgAmpBP.setTop(red2AvgAmpTitleL);
				red2AvgTrapBP.setTop(red2AvgTrapTitleL);
				red2AvgCliBP.setTop(red2AvgCliTitleL);
				red2AvgCyBP.setCenter(red2AvgCyStatL);
				red2AvgSpeBP.setCenter(red2AvgSpeStatL);
				red2AvgAmpBP.setCenter(red2AvgAmpStatL);
				red2AvgTrapBP.setCenter(red2AvgTrapStatL);
				red2AvgCliBP.setCenter(red2AvgCliStatL);
			...
			if(mainTeamNum3 != 0) {
				...
				Label redTeam3NumL = new Label(Integer.toString(mainTeamNum3) + "'s Stats");
				...
				Label red3MatchCyStatL = new Label(Integer.toString(redSortedTeams.get(2).getMatchSpe() + redSortedTeams.get(2).getMatchAmp() + redSortedTeams.get(2).getMatchTrap()));
				...
				Label red3AvgCyStatL = new Label(Double.toString(mainTeam3.getAvgSpe() + mainTeam1.getAvgAmp() + mainTeam1.getAvgTrap()));
				Label red3AvgSpeStatL = new Label(Double.toString(mainTeam3.getAvgSpe()));
				Label red3AvgAmpStatL = new Label(Double.toString(mainTeam3.getAvgAmp()));
				Label red3AvgTrapStatL = new Label(Double.toString(mainTeam3.getAvgTrap()));
				Label red3AvgCliStatL = new Label(Double.toString(mainTeam3.getAvgClimb()));
				redTeam3NumL.setId("TitleLabelPlay");
				...
				red3MatchCyStatL.setId("avgStat");
				red3MatchSpeStatL.setId("avgStat");
				red3MatchAmpStatL.setId("avgStat");
				red3MatchTrapStatL.setId("avgStat");
				red3MatchCliStatL.setId("avgStat");
				...
				red3AvgCyStatL.setId("avgStat");
				red3AvgSpeStatL.setId("avgStat");
				red3AvgAmpStatL.setId("avgStat");
				red3AvgTrapStatL.setId("avgStat");
				red3AvgCliStatL.setId("avgStat");
				...
				red3AvgCyBP.setTop(red3AvgCyTitleL);
				red3AvgSpeBP.setTop(red3AvgSpeTitleL);
				red3AvgAmpBP.setTop(red3AvgAmpTitleL);
				red3AvgTrapBP.setTop(red3AvgTrapTitleL);
				red3AvgCliBP.setTop(red3AvgCliTitleL);
				red3AvgCyBP.setCenter(red3AvgCyStatL);
				red3AvgSpeBP.setCenter(red3AvgSpeStatL);
				red3AvgAmpBP.setCenter(red3AvgAmpStatL);
				red3AvgTrapBP.setCenter(red3AvgTrapStatL);
				red3AvgCliBP.setCenter(red3AvgCliStatL);
			...
			if(mainTeamNum4 != 0) {
				...
				Label redTeam4NumL = new Label(Integer.toString(mainTeamNum4) + "'s Stats");
				...
				Label red4MatchCyStatL = new Label(Integer.toString(redSortedTeams.get(3).getMatchSpe() + redSortedTeams.get(3).getMatchAmp() + redSortedTeams.get(3).getMatchTrap()));
				...
				Label red4AvgCyStatL = new Label(Double.toString(mainTeam4.getAvgSpe() + mainTeam1.getAvgAmp() + mainTeam1.getAvgTrap()));
				Label red4AvgSpeStatL = new Label(Double.toString(mainTeam4.getAvgSpe()));
				Label red4AvgAmpStatL = new Label(Double.toString(mainTeam4.getAvgAmp()));
				Label red4AvgTrapStatL = new Label(Double.toString(mainTeam4.getAvgTrap()));
				Label red4AvgCliStatL = new Label(Double.toString(mainTeam4.getAvgClimb()));
				redTeam4NumL.setId("TitleLabelPlay");
				...
				red4MatchCyStatL.setId("avgStat");
				red4MatchSpeStatL.setId("avgStat");
				red4MatchAmpStatL.setId("avgStat");
				red4MatchTrapStatL.setId("avgStat");
				red4MatchCliStatL.setId("avgStat");
				...
				red4AvgCyStatL.setId("avgStat");
				red4AvgSpeStatL.setId("avgStat");
				red4AvgAmpStatL.setId("avgStat");
				red4AvgTrapStatL.setId("avgStat");
				red4AvgCliStatL.setId("avgStat");
				...
				red4AvgCyBP.setTop(red4AvgCyTitleL);
				red4AvgSpeBP.setTop(red4AvgSpeTitleL);
				red4AvgAmpBP.setTop(red4AvgAmpTitleL);
				red4AvgTrapBP.setTop(red4AvgTrapTitleL);
				red4AvgCliBP.setTop(red4AvgCliTitleL);
				red4AvgCyBP.setCenter(red4AvgCyStatL);
				red4AvgSpeBP.setCenter(red4AvgSpeStatL);
				red4AvgAmpBP.setCenter(red4AvgAmpStatL);
				red4AvgTrapBP.setCenter(red4AvgTrapStatL);
				red4AvgCliBP.setCenter(red4AvgCliStatL);
			...
			BorderPane redTotalCyBP = new BorderPane();
			BorderPane redTotalSpeBP = new BorderPane();
			BorderPane redTotalAmpBP = new BorderPane();
			BorderPane redTotalTrapBP = new BorderPane();
			BorderPane redTotalCliBP = new BorderPane();
			redTotalCyBP.setTop(redTotalCyTitleL);
			redTotalSpeBP.setTop(redTotalSpeTitleL);
			redTotalAmpBP.setTop(redTotalAmpTitleL);
			redTotalTrapBP.setTop(redTotalTrapTitleL);
			redTotalCliBP.setTop(redTotalCliTitleL);
			redTotalCyBP.setCenter(redTotalCyStatL);
			redTotalSpeBP.setCenter(redTotalSpeStatL);
			redTotalAmpBP.setCenter(redTotalAmpStatL);
			redTotalTrapBP.setCenter(redTotalTrapStatL);
			redTotalCliBP.setCenter(redTotalCliStatL);
			redTotalCyBP.setId("seMStatBP5");
			redTotalSpeBP.setId("seMStatBP4");
			redTotalAmpBP.setId("seMStatBP3");
			redTotalTrapBP.setId("seMStatBP2");
			redTotalCliBP.setId("seMStatBP1");
			Label redTitleL = new Label("Red Allince's Stats");
			redTitleL.setId("smallTitle");
			BorderPane redTitleBP = new BorderPane();
			redTitleBP.setCenter(redTitleL);
			redTitleBP.setId("seMTotalBP6");
			redTotalVB.getChildren().addAll(redTitleBP, redTotalCyBP, redTotalSpeBP, redTotalAmpBP, redTotalTrapBP, redTotalCliBP);
			Label blueTotalCyTitleL = new Label("Cycles");
			Label blueTotalSpeTitleL = new Label("Speakers");
			Label blueTotalAmpTitleL = new Label("Amp");
			Label blueTotalTrapTitleL = new Label("Trap");
			Label blueTotalCliTitleL = new Label("Climb");
			Label blueTotalCyStatL = new Label(Integer.toString(totalBlueCy));
			Label blueTotalSpeStatL = new Label(Integer.toString(totalBlueSpe));
			Label blueTotalAmpStatL = new Label(Integer.toString(totalBlueAmp));
			Label blueTotalTrapStatL = new Label(Integer.toString(totalBlueTrap));
			Label blueTotalCliStatL = new Label(Integer.toString(totalBlueCli));
			blueTotalCyTitleL.setId("TitleLabelPlay");
			blueTotalSpeTitleL.setId("smallTitle");
			blueTotalAmpTitleL.setId("smallTitle");
			blueTotalTrapTitleL.setId("smallTitle");
			blueTotalCliTitleL.setId("smallTitle");
			blueTotalCyStatL.setId("avgStat");
			blueTotalSpeStatL.setId("avgStat");
			blueTotalAmpStatL.setId("avgStat");
			blueTotalTrapStatL.setId("avgStat");
			blueTotalCliStatL.setId("avgStat");
			BorderPane blueTotalCyBP = new BorderPane();
			BorderPane blueTotalSpeBP = new BorderPane();
			BorderPane blueTotalAmpBP = new BorderPane();
			BorderPane blueTotalTrapBP = new BorderPane();
			BorderPane blueTotalCliBP = new BorderPane();
			blueTotalCyBP.setTop(blueTotalCyTitleL);
			blueTotalSpeBP.setTop(blueTotalSpeTitleL);
			blueTotalAmpBP.setTop(blueTotalAmpTitleL);
			blueTotalTrapBP.setTop(blueTotalTrapTitleL);
			blueTotalCliBP.setTop(blueTotalCliTitleL);
			blueTotalCyBP.setCenter(blueTotalCyStatL);
			blueTotalSpeBP.setCenter(blueTotalSpeStatL);
			blueTotalAmpBP.setCenter(blueTotalAmpStatL);
			blueTotalTrapBP.setCenter(blueTotalTrapStatL);
			blueTotalCliBP.setCenter(blueTotalCliStatL);
			blueTotalCyBP.setId("seMStatBP5");
			blueTotalSpeBP.setId("seMStatBP4");
			blueTotalAmpBP.setId("seMStatBP3");
			blueTotalTrapBP.setId("seMStatBP2");
			blueTotalCliBP.setId("seMStatBP1");
			Label blueTitleL = new Label("Blue Allince's Stats");
			blueTitleL.setId("smallTitle");
			BorderPane blueTitleBP = new BorderPane();
			blueTitleBP.setCenter(blueTitleL);
			blueTitleBP.setId("seMTotalBP6");
			blueTotalVB.getChildren().addAll(blueTitleBP, blueTotalCyBP, blueTotalSpeBP, blueTotalAmpBP, blueTotalTrapBP, blueTotalCliBP);
		}else {
			System.out.println("boopseMPlay10Else");
			Label blueTeam1TitleL = new Label("Captain");
			Label blueTeam2TitleL = new Label("1st Pick");
			Label blueTeam3TitleL = new Label("2nd Pick");
			Label blueTeam4TitleL = new Label("Backup");
			System.out.println("boopseMPlay11Else");
			blueTeam1TitleL.setId("smallerTitle");
			blueTeam2TitleL.setId("smallerTitle");
			blueTeam3TitleL.setId("smallerTitle");
			blueTeam4TitleL.setId("smallerTitle");
			System.out.println("boopseMPlay12Else");
			int totalBlueCy = 0;
			int totalBlueSpe = 0;
			int totalBlueAmp = 0;
			int totalBlueTrap = 0;
			...
			int totalRedTrap = 0;
			int totalRedCli = 0;
			System.out.println("boopseMPlay13Else");
			if(mainTeamNum1 != 0) {
				System.out.println("boopseMPlay14Else");
				Label blueTeam1NumL = new Label(Integer.toString(mainTeamNum1) + "'s Stats");
				Label blue1MatchCyTitleL = new Label("Cycles");
				Label blue1MatchSpeTitleL = new Label("Speakers");
				Label blue1MatchAmpTitleL = new Label("Amp");
				Label blue1MatchTrapTitleL = new Label("Trap");
				...
				Label blue1AvgTrapTitleL = new Label("Avg Trap");
				Label blue1AvgCliTitleL = new Label("Avg Climb");
				Label blue1AvgCyStatL = new Label(Double.toString(mainTeam1.getAvgSpe() + mainTeam1.getAvgAmp() + mainTeam1.getAvgTrap()));
				...
				blue1MatchAmpStatL.setId("avgStat");
				blue1MatchTrapStatL.setId("avgStat");
				blue1MatchCliStatL.setId("avgStat");
				blue1AvgCyTitleL.setId("smallTitle");
				blue1AvgSpeTitleL.setId("smallTitle");
				blue1AvgAmpTitleL.setId("smallTitle");
				blue1AvgTrapTitleL.setId("smallTitle");
				...
				blue1AvgTrapStatL.setId("avgStat");
				blue1AvgCliStatL.setId("avgStat");
				System.out.println("boopseMPlay15Else");
				BorderPane blue1CyBP = new BorderPane();
				BorderPane blue1SpeBP = new BorderPane();
				BorderPane blue1AmpBP = new BorderPane();
				BorderPane blue1TrapBP = new BorderPane();
				...
				blue1AvgTrapBP.setId("seMStatBP4");
				blue1AvgCliBP.setId("seMStatBP5");
				System.out.println("boopseMPlay16Else");
				BorderPane blueTitle1BP = new BorderPane();
				blueTitle1BP.setCenter(blueTeam1NumL);
				blueTitle1BP.setBottom(blueTeam1TitleL);
				blueTitle1BP.setId("seMStatBP6");
				blue1VB.getChildren().addAll(blueTitle1BP, blue1CyBP, blue1AvgCyBP, blue1SpeBP, blue1AvgSpeBP, blue1AmpBP, blue1AvgAmpBP, blue1TrapBP, blue1AvgTrapBP, blue1CliBP, blue1AvgCliBP);
				System.out.println("boopseMPlay17Else");
			}
			System.out.println("boopseMPlay18Else");
			if(mainTeamNum2 != 0) {
				System.out.println("boopseMPlay19Else");
				Label blueTeam2NumL = new Label(Integer.toString(mainTeamNum2) + "'s Stats");
				Label blue2MatchCyTitleL = new Label("Cycles");
				Label blue2MatchSpeTitleL = new Label("Speakers");
				Label blue2MatchAmpTitleL = new Label("Amp");
				Label blue2MatchTrapTitleL = new Label("Trap");
				...
				Label blue2AvgTrapTitleL = new Label("Avg Trap");
				Label blue2AvgCliTitleL = new Label("Avg Climb");
				Label blue2AvgCyStatL = new Label(Double.toString(mainTeam2.getAvgSpe() + mainTeam1.getAvgAmp() + mainTeam1.getAvgTrap()));
			...
			if(mainTeamNum3 != 0) {
				Label blueTeam3NumL = new Label(Integer.toString(mainTeamNum3) + "'s Stats");
				Label blue3MatchCyTitleL = new Label("Cycles");
				Label blue3MatchSpeTitleL = new Label("Speakers");
				Label blue3MatchAmpTitleL = new Label("Amp");
				Label blue3MatchTrapTitleL = new Label("Trap");
				...
				Label blue3AvgTrapTitleL = new Label("Avg Trap");
				Label blue3AvgCliTitleL = new Label("Avg Climb");
				Label blue3AvgCyStatL = new Label(Double.toString(mainTeam3.getAvgSpe() + mainTeam1.getAvgAmp() + mainTeam1.getAvgTrap()));
				...
				blue3AvgTrapBP.setId("seMStatBP4");
				blue3AvgCliBP.setId("seMStatBP5");
				System.out.println("boopseMPlay20Else");
				BorderPane blueTitle3BP = new BorderPane();
				blueTitle3BP.setCenter(blueTeam3NumL);
				blueTitle3BP.setBottom(blueTeam3TitleL);
				blueTitle3BP.setId("seMStatBP6");
				blue3VB.getChildren().addAll(blueTitle3BP, blue3CyBP, blue3AvgCyBP, blue3SpeBP, blue3AvgSpeBP, blue3AmpBP, blue3AvgAmpBP, blue3TrapBP, blue3AvgTrapBP, blue3CliBP, blue3AvgCliBP);
				System.out.println("boopseMPlay21Else");
				
			}
			System.out.println("boopseMPlay22Else");
			if(mainTeamNum4 != 0) {
				System.out.println("boopseMPlay23Else");
				Label blueTeam4NumL = new Label(Integer.toString(mainTeamNum4) + "'s Stats");
				Label blue4MatchCyTitleL = new Label("Cycles");
				Label blue4MatchSpeTitleL = new Label("Speakers");
				Label blue4MatchAmpTitleL = new Label("Amp");
				Label blue4MatchTrapTitleL = new Label("Trap");
			...
			System.out.println("boopseMPlay24Else");
			Label redTeam1TitleL = new Label("Captain");
			Label redTeam2TitleL = new Label("1st Pick");
			Label redTeam3TitleL = new Label("2nd Pick");
			Label redTeam4TitleL = new Label("Backup");
			...
			redTeam3TitleL.setId("smallerTitle");
			redTeam4TitleL.setId("smallerTitle");
			System.out.println("boopseMPlay25Else");
			if(nonTeamNum1 != 0) {
				System.out.println("boopseMPlay26Else");
				Label redTeam1NumL = new Label(Integer.toString(nonTeamNum1) + "'s Stats");
				Label red1MatchCyTitleL = new Label("Cycles");
				Label red1MatchSpeTitleL = new Label("Speakers");
				Label red1MatchAmpTitleL = new Label("Amp");
				Label red1MatchTrapTitleL = new Label("Trap");
			...
			System.out.println("boopseMPlay27Else");
			if(nonTeamNum2 != 0) {
				System.out.println("boopseMPlay28Else");
				Label redTeam2NumL = new Label(Integer.toString(nonTeamNum2) + "'s Stats");
				Label red2MatchCyTitleL = new Label("Cycles");
				Label red2MatchSpeTitleL = new Label("Speakers");
				Label red2MatchAmpTitleL = new Label("Amp");
				Label red2MatchTrapTitleL = new Label("Trap");
				...
				Label red2AvgTrapTitleL = new Label("Avg Trap");
				Label red2AvgCliTitleL = new Label("Avg Climb");
				Label red2AvgCyStatL = new Label(Double.toString(nonTeam2.getAvgSpe() + nonTeam2.getAvgAmp() + nonTeam2.getAvgTrap()));
			...
			System.out.println("boopseMPlay29Else");
			if(nonTeamNum3 != 0) {
				System.out.println("boopseMPlay30Else");
				Label redTeam3NumL = new Label(Integer.toString(nonTeamNum3) + "'s Stats");
				Label red3MatchCyTitleL = new Label("Cycles");
				Label red3MatchSpeTitleL = new Label("Speakers");
				Label red3MatchAmpTitleL = new Label("Amp");
				Label red3MatchTrapTitleL = new Label("Trap");
				...
				Label red3AvgTrapTitleL = new Label("Avg Trap");
				Label red3AvgCliTitleL = new Label("Avg Climb");
				Label red3AvgCyStatL = new Label(Double.toString(nonTeam3.getAvgSpe() + nonTeam3.getAvgAmp() + nonTeam3.getAvgTrap()));
			...
			if(nonTeamNum4 != 0) {
				Label redTeam4NumL = new Label(Integer.toString(nonTeamNum4) + "'s Stats");
				Label red4MatchCyTitleL = new Label("Cycles");
				Label red4MatchSpeTitleL = new Label("Speakers");
				Label red4MatchAmpTitleL = new Label("Amp");
				Label red4MatchTrapTitleL = new Label("Trap");
				...
				Label red4AvgTrapTitleL = new Label("Avg Trap");
				Label red4AvgCliTitleL = new Label("Avg Climb");
				Label red4AvgCyStatL = new Label(Double.toString(nonTeam4.getAvgSpe() + nonTeam4.getAvgAmp() + nonTeam4.getAvgTrap()));
				...
				BorderPane red4TrapBP = new BorderPane();
				BorderPane red4CliBP = new BorderPane();
				red4CyBP.setTop(red4AvgCyTitleL);
				red4SpeBP.setTop(red4AvgSpeTitleL);
				red4AmpBP.setTop(red4AvgAmpTitleL);
				red4TrapBP.setTop(red4AvgTrapTitleL);
				red4CliBP.setTop(red4AvgCliTitleL);
				red4CyBP.setCenter(red4AvgCyStatL);
				red4SpeBP.setCenter(red4AvgSpeStatL);
				red4AmpBP.setCenter(red4AvgAmpStatL);
				red4TrapBP.setCenter(red4AvgTrapStatL);
				red4CliBP.setCenter(red4AvgCliStatL);
				red4CyBP.setId("seMStatBP1");
				red4SpeBP.setId("seMStatBP2");
				red4AmpBP.setId("seMStatBP3");
				red4TrapBP.setId("seMStatBP4");
			...
			Label blueTotalTrapStatL = new Label(Integer.toString(totalBlueTrap));
			Label blueTotalCliStatL = new Label(Integer.toString(totalBlueCli));
			blueTotalCyTitleL.setId("smallTitle");
			blueTotalSpeTitleL.setId("smallTitle");
			blueTotalAmpTitleL.setId("smallTitle");
			blueTotalTrapTitleL.setId("smallTitle");
			blueTotalCliTitleL.setId("smallTitle");
			...
			blueTotalTrapBP.setId("seMStatBP2");
			blueTotalCliBP.setId("seMStatBP1");
			Label blueTitleL = new Label("Red Allince's Stats");
			blueTitleL.setId("smallTitle");
			BorderPane blueTitleBP = new BorderPane();
			blueTitleBP.setCenter(blueTitleL);
			blueTitleBP.setId("seMTotalBP6");
		...
		if(mainColor = false) {
			mainHB.getChildren().addAll(blueTotalVB);
			nonHB.getChildren().addAll(redTotalVB);
			if(isBlueTeam1 == true) {
			...
			mainHB.getChildren().addAll(redTotalVB);
			nonHB.getChildren().addAll(blueTotalVB);
			if(isRedTeam1 == true) {
				mainHB.getChildren().addAll(red1VB);
			}
			if(isRedTeam2 == true) {
				mainHB.getChildren().addAll(red2VB);
			}
			if(isRedTeam3 == true) {
	...
	public int findNonAll(int tempTeamNum) {
		...
		if(thePOA.getAlliance2() != null) {
			System.out.println("boopseMPlay7.9.0.4");
			if(thePOA.getAlliance2().getTeam1() != null) {
				if(thePOA.getAlliance2().getTeam1().getTeamNum() == tempTeamNum) {
					return 2;
				}
			}
			System.out.println("boopseMPlay7.9.0.5");
			if(thePOA.getAlliance2().getTeam2() != null) {
				if(thePOA.getAlliance2().getTeam2().getTeamNum() == tempTeamNum) {
					return 2;
				}
			}
			System.out.println("boopseMPlay7.9.0.6");
			if(thePOA.getAlliance2().getTeam3() != null) {
	...
	public void handle(ActionEvent event) {
		try {
			...
			if(event.getSource() == submitPlayB) {
				System.out.println("boopseMPlay0");
				this.getChildren().clear();
				System.out.println("boopseMPlay1");
				String allNumS = allCB.getSelectionModel().getSelectedItem();
				String matchNumS = matchNumTF.getText();
				String isReplayS = isReplayCB.getSelectionModel().getSelectedItem();
				System.out.println("boopseMPlay2");
				int allNum = Integer.parseInt(allNumS);
				int matchNum = Integer.parseInt(matchNumS);
				boolean isReplay = Boolean.parseBoolean(isReplayS);
				System.out.println("boopseMPlay3");
