			...
			if(event.getSource() == submitNonB){
				...
				if(blueTeams.size() == 3) {
					...
					if(mainColor == false) {
						...
						Label blueCy = new Label(Integer.toString(blueTeams.get(0).getMatchAmp() + blueTeams.get(1).getMatchAmp() + blueTeams.get(2).getMatchAmp() + blueTeams.get(0).getMatchSpe() + blueTeams.get(1).getMatchSpe() + blueTeams.get(2).getMatchSpe()) + Integer.toString(blueTeams.get(0).getMatchTrap() + blueTeams.get(1).getMatchTrap() + blueTeams.get(2).getMatchTrap()));
