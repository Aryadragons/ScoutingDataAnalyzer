	...
	public void setPlayoffStuff(int selAll, int matchNum, boolean isRePlay) {
		...
		if(mainColor == true) {
			...
			if(mainTeamNum1 != 0) {
				...
				Label redTeam1NumL = new Label(Integer.toString(mainTeamNum1));
			...
			if(mainTeamNum2 != 0) {
				...
				Label redTeam2NumL = new Label(Integer.toString(mainTeamNum2));
			...
			if(mainTeamNum3 != 0) {
				...
				Label redTeam3NumL = new Label(Integer.toString(mainTeamNum3));
			...
			if(mainTeamNum4 != 0) {
				...
				Label redTeam4NumL = new Label(Integer.toString(mainTeamNum4));
			...
			if(mainTeamNum4 != 0) {
				...
				Label blueTeam4NumL = new Label(Integer.toString(mainTeamNum4));
				Label blue4MatchCyTitleL = new Label("Cycles");
				Label blue4MatchSpeTitleL = new Label("Speakers");
				Label blue4MatchAmpTitleL = new Label("Amp");
				Label blue4MatchTrapTitleL = new Label("Trap");
