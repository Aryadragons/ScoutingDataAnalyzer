...
public class compareAlliancesTab extends GridPane{
	...
	public void addCompare3Alls(Team a1T1, Team a1T2, Team a1T3, Team a2T1, Team a2T2, Team a2T3, Team a3T1, Team a3T2, Team a3T3) {
		...
		a1T2CyBP.setId("comAllstatBP1");
		a1T2SpeBP.setId("comAllstatBP2");
		a1T2AmpBP.setId("comAllstatBP3");
		a1T2TrapBP.setId("comAllstatBP4");
		a1T2CliBP.setId("comAllstatBP2");
		a1T2HighNBP.setId("comAllstatBP3");
		a1T2TimesScoBP.setId("comAllstatBP4");
		a1T2TimesAmpBP.setId("comAllstatBP5");
		...
		a1T3CyBP.setId("comAllstatBP1");
		a1T3SpeBP.setId("comAllstatBP2");
		a1T3AmpBP.setId("comAllstatBP3");
		a1T3TrapBP.setId("comAllstatBP4");
		a1T3CliBP.setId("comAllstatBP2");
		a1T3HighNBP.setId("comAllstatBP3");
		a1T3TimesScoBP.setId("comAllstatBP4");
		a1T3TimesAmpBP.setId("comAllstatBP5");
		...
		a2T2CyBP.setId("comAllstatBP1");
		a2T2SpeBP.setId("comAllstatBP2");
		a2T2AmpBP.setId("comAllstatBP3");
		a2T2TrapBP.setId("comAllstatBP4");
		a2T2CliBP.setId("comAllstatBP2");
		a2T2HighNBP.setId("comAllstatBP3");
		a2T2TimesScoBP.setId("comAllstatBP4");
		a2T2TimesAmpBP.setId("comAllstatBP5");
		...
		a2T3CyBP.setId("comAllstatBP1");
		a2T3SpeBP.setId("comAllstatBP2");
		a2T3AmpBP.setId("comAllstatBP3");
		a2T3TrapBP.setId("comAllstatBP4");
		a2T3CliBP.setId("comAllstatBP2");
		a2T3HighNBP.setId("comAllstatBP3");
		a2T3TimesScoBP.setId("comAllstatBP4");
		a2T3TimesAmpBP.setId("comAllstatBP5");
		...
		a3T2CyBP.setId("comAllstatBP1");
		a3T2SpeBP.setId("comAllstatBP2");
		a3T2AmpBP.setId("comAllstatBP3");
		a3T2TrapBP.setId("comAllstatBP4");
		a3T2CliBP.setId("comAllstatBP2");
		a3T2HighNBP.setId("comAllstatBP3");
		a3T2TimesScoBP.setId("comAllstatBP4");
		a3T2TimesAmpBP.setId("comAllstatBP5");
		...
		a3T3CyBP.setId("comAllstatBP1");
		a3T3SpeBP.setId("comAllstatBP2");
		a3T3AmpBP.setId("comAllstatBP3");
		a3T3TrapBP.setId("comAllstatBP4");
		a3T3CliBP.setId("comAllstatBP2");
		a3T3HighNBP.setId("comAllstatBP3");
		a3T3TimesScoBP.setId("comAllstatBP4");
		a3T3TimesAmpBP.setId("comAllstatBP5");
		...
		a1T1VB.getChildren().addAll(a1T1CyBP, a1T1SpeBP, a1T1AmpBP, a1T1TrapBP, a1T1CliBP, a1T1HighNBP, a1T1TimesScoBP, a1T1TimesAmpBP);
		a1T2VB.getChildren().addAll(a1T2CyBP, a1T2SpeBP, a1T2AmpBP, a1T2TrapBP, a1T2CliBP, a1T2HighNBP, a1T2TimesScoBP, a1T2TimesAmpBP);
		a1T3VB.getChildren().addAll(a1T3CyBP, a1T3SpeBP, a1T3AmpBP, a1T3TrapBP, a1T3CliBP, a1T3HighNBP, a1T3TimesScoBP, a1T3TimesAmpBP);
		a2T1VB.getChildren().addAll(a2T1CyBP, a2T1SpeBP, a2T1AmpBP, a2T1TrapBP, a2T1CliBP, a2T1HighNBP, a2T1TimesScoBP, a2T1TimesAmpBP);
		a2T2VB.getChildren().addAll(a2T2CyBP, a2T2SpeBP, a2T2AmpBP, a2T2TrapBP, a2T2CliBP, a2T2HighNBP, a2T2TimesScoBP, a2T2TimesAmpBP);
		a2T3VB.getChildren().addAll(a2T3CyBP, a2T3SpeBP, a2T3AmpBP, a2T3TrapBP, a2T3CliBP, a2T3HighNBP, a2T3TimesScoBP, a2T3TimesAmpBP);
		a3T1VB.getChildren().addAll(a3T1CyBP, a3T1SpeBP, a3T1AmpBP, a3T1TrapBP, a3T1CliBP, a3T1HighNBP, a3T1TimesScoBP, a3T1TimesAmpBP);
		a3T2VB.getChildren().addAll(a3T2CyBP, a3T2SpeBP, a3T2AmpBP, a3T2TrapBP, a3T2CliBP, a3T2HighNBP, a3T2TimesScoBP, a3T2TimesAmpBP);
		a3T3VB.getChildren().addAll(a3T3CyBP, a3T3SpeBP, a3T3AmpBP, a3T3TrapBP, a3T3CliBP, a3T3HighNBP, a3T3TimesScoBP, a3T3TimesAmpBP);
		this.add(new Label("    "), 0, 0);
		this.add(new Label("    "), 2, 0);
		this.add(new Label("    "), 4, 0);
